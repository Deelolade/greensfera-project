    ...
    <div className=" bg-gray-50">
      <div className="max-w-max mx-auto px-4 py-5 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  gap-10 lg:gap-32  lg:px-20">
          <img src={aboutImageTwo} alt="" className='h-auto lg:h-[700px] object-cover' />
          <div className="lg:py-10 flex flex-col justify-center">
          ...
          <img src={aboutImage} alt="" className='h-auto lg:h-[700px] object-cover' />
        </div>
      </div>
    </div>
  );
