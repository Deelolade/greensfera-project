...
const LearnMore = () => {
  return (
    <section className=" h-[60vh] lg:h-[90vh] w-full bg-gradient-to-br from-[#009B4C] to-[#0A3B2E]  py-6 px-3  lg:p-20">
        ...
        <button className='text-white font-semibold bg-[#009B4C] px-8  py-3 mt-3 rounded-md hover:bg-[#007A3D] transition-all hover:shadow-lg hover:shadow-[#009B4C]/30'>Our Projects</button>
        </div>
        </div>
