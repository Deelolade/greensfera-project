    ...
    <div className='relative bg-gradient-to-br from-[#009B4C] to-[#0A3B2E] overflow-hidden'>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-white font-medium"> Today, GreenSfera is helping communities adopt smarter, cleaner habits and we’re just getting started. </p> </div>

              <div className="flex flex-wrap gap-4 pt-4">
                <button className="bg-white text-[#009B4C] px-8 py-4 rounded-full font-semibold hover:bg-white/90 transition-all shadow-xl hover:shadow-2xl hover:scale-105 inline-flex items-center gap-2">
                  <span>Join the Movement</span>
                  <ArrowRight className="w-5 h-5" />
                </button>
                <button className="bg-white/10 backdrop-blur-md text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all border border-white/30 inline-flex items-center gap-2">
                  ...
                  {quotes.map((quote, index) => (
                    ...
                    >
                      <div className="flex flex-col h-full justify-between">
                        <div>
                          <div className="text-white/40 text-8xl font-serif leading-none mb-4">"</div>
                          <p className="text-2xl lg:text-3xl text-white font-medium leading-relaxed">
                            {quote.text}
                          </p>
                        </div>
                        <div className="text-white/70 text-sm font-medium mt-8">
                          — {quote.author}
                        </div>
                      </div>
                    </div>
        ...
        <div className="pb-20 lg:pb-32">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 lg:p-16 border border-white/20">
